...
class ViewLeave extends ViewRecord
{
    ...
    public function approve(): void
    {
        try {
            ...
            Notification::make()
                ...
                ->success()
                ->actions([
                    ActionsAction::make('View Details')->url(route('filament.' . env('PANEL_PATH') . '.resources.leaves.view', $this->record->id)),
            ...
            Notification::make()
                ...
                ->success()
                ->actions([
                    ActionsAction::make('View Detail')->url(route('filament.' . env('PANEL_PATH') . '.resources.leaves.view', $this->record->id)),
    ...
    {
        redirect(route('filament.' . env('PANEL_PATH') . '.resources.leaves.view', $this->record->id));
    }
}
