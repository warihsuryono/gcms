...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('purchase_orders', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('purchase_request_id')->default(0)->nullable();
            ...
            $table->smallInteger('is_closed')->nullable()->default(0);
            $table->dateTime('closed_at')->nullable();
            $table->unsignedBigInteger('closed_by')->default(0)->nullable();
            $table->smallInteger('is_hold')->nullable()->default(0);
            ...
            $table->smallInteger('is_authorized')->nullable()->default(0);
