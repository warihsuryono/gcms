...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('dashboards', function (Blueprint $table) {
            ...
            $table->integer('widget_1_top')->nullable()->default(0);
            $table->integer('widget_1_left')->nullable()->default(0);
            $table->string('widget_2')->nullable()->default('');
            $table->integer('widget_2_top')->nullable()->default(0);
            $table->integer('widget_2_left')->nullable()->default(0);
            $table->string('widget_3')->nullable()->default('');
            $table->integer('widget_3_top')->nullable()->default(0);
            $table->integer('widget_3_left')->nullable()->default(0);
