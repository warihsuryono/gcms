...
class StockSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        StockOpnameDetail::create(['stock_opname_id' => 1, 'item_id' => 3, 'unit_id' => 10, 'qty' => 10, 'actual_qty' => 0, 'notes' => Item::find(3)->name . ' initial stock']);
        StockOpnameDetail::create(['stock_opname_id' => 1, 'item_id' => 4, 'unit_id' => 10, 'qty' => 20, 'actual_qty' => 0, 'notes' => Item::find(4)->name . ' initial stock']);
        StockOpnameDetail::create(['stock_opname_id' => 1, 'item_id' => 5, 'unit_id' => 10, 'qty' => 30, 'actual_qty' => 0, 'notes' => Item::find(5)->name . ' initial stock']);
        StockOpnameDetail::create(['stock_opname_id' => 1, 'item_id' => 6, 'unit_id' => 10, 'qty' => 25, 'actual_qty' => 0, 'notes' => Item::find(6)->name . ' initial stock']);
        StockOpnameDetail::create(['stock_opname_id' => 1, 'item_id' => 7, 'unit_id' => 10, 'qty' => 20, 'actual_qty' => 0, 'notes' => Item::find(7)->name . ' initial stock']);
        StockOpnameDetail::create(['stock_opname_id' => 1, 'item_id' => 8, 'unit_id' => 10, 'qty' => 15, 'actual_qty' => 0, 'notes' => Item::find(8)->name . ' initial stock']);
        StockOpnameDetail::create(['stock_opname_id' => 1, 'item_id' => 9, 'unit_id' => 10, 'qty' => 10, 'actual_qty' => 0, 'notes' => Item::find(9)->name . ' initial stock']);
        StockOpnameDetail::create(['stock_opname_id' => 1, 'item_id' => 10, 'unit_id' => 10, 'qty' => 5, 'actual_qty' => 0, 'notes' => Item::find(10)->name . ' initial stock']);
        ...
        ItemStock::create(['item_id' => 3, 'warehouse_detail_ids' => Item::find(3)->warehouse_detail_ids, 'qty' => 10]);
        ItemStock::create(['item_id' => 4, 'warehouse_detail_ids' => Item::find(4)->warehouse_detail_ids, 'qty' => 20]);
        ItemStock::create(['item_id' => 5, 'warehouse_detail_ids' => Item::find(5)->warehouse_detail_ids, 'qty' => 30]);
        ItemStock::create(['item_id' => 6, 'warehouse_detail_ids' => Item::find(6)->warehouse_detail_ids, 'qty' => 25]);
        ItemStock::create(['item_id' => 7, 'warehouse_detail_ids' => Item::find(7)->warehouse_detail_ids, 'qty' => 20]);
        ItemStock::create(['item_id' => 8, 'warehouse_detail_ids' => Item::find(8)->warehouse_detail_ids, 'qty' => 15]);
        ItemStock::create(['item_id' => 9, 'warehouse_detail_ids' => Item::find(9)->warehouse_detail_ids, 'qty' => 10]);
        ItemStock::create(['item_id' => 10, 'warehouse_detail_ids' => Item::find(10)->warehouse_detail_ids, 'qty' => 5]);
        ItemStock::create(['item_id' => 12, 'warehouse_detail_ids' => Item::find(12)->warehouse_detail_ids, 'qty' => 2]);
        ItemStock::create(['item_id' => 13, 'warehouse_detail_ids' => Item::find(13)->warehouse_detail_ids, 'qty' => 1]);
    }
}
