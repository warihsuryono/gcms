...
class users extends Seeder
{
    ...
    public function run(): void
    {
        ...
        User::create(['id' => '2', 'privilege_id' => 2, 'email' => 'admin@gcms.co.id', 'name' => 'Administrator', 'msisdn' => '+62-', 'password' => '$2y$12$r3oK0.xb.tDW/JmZ2scaV.cZQnILPA1fYqsCpDhAqtkOoe1snQwGK']);
    }
}
