<x-filament-panels::page x-data="{ showButtonSelectedToAction: false }">
    @if ($this->hasInfolist())
        {{ $this->infolist }}
    @else
        {{ $this->form }}
    ...
    <div class="flex justify-between">
        <div></div>
        <x-filament::button class='h-10' wire:click="createPurchaseOrder()" x-show='showButtonSelectedToAction'>
        ...
        @if ($this->getRecord()->is_acknowledge)
            <div>
                ...
                <img style='height:100px'
                    src='{{ asset('storage/' . $this->getRecord()->AcknowledgeBy->signature) }}' />
